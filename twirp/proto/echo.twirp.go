...
func (c *echoProtobufClient) callSay(ctx context.Context, in *Request) (*Response, error) {
	out := new(Response)
...
func (c *echoJSONClient) callSay(ctx context.Context, in *Request) (*Response, error) {
	out := new(Response)
		...
		handler = func(ctx context.Context, req *Request) (*Response, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Echo.Say(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Response)
...
var twirpFileDescriptor0 = []byte{
	...
	0xc4, 0x4a, 0x21, 0x0e, 0x3d, 0xa8, 0x61, 0x52, 0x9c, 0x7a, 0x30, 0x7d, 0x4e, 0x1c, 0x51, 0x6c,
	0xfa, 0x60, 0xcb, 0x92, 0xd8, 0xc0, 0x94, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xfa, 0x2c, 0x9c,
	0x0a, 0x81, 0x00, 0x00, 0x00,
}
